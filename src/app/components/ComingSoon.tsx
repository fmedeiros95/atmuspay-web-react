...
const ComingSoon = (props?: any): JSX.Element => {
	return (
		<div className="text-center">
			<svg className="svg-computer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 424.2 424.2">
				<g>
			...
			<h3 className="mt-4">Recurso disponível em breve!</h3>
			<p className="text-muted">Vamos te notificar quando este recurso estiver disponível.</p>
			{ (!props?.noBtn && <Link to="/" className="btn btn-success mt-3">
